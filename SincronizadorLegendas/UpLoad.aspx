<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpLoad.aspx.cs" Inherits="SincronizadorLegendas.UpLoad" %>
...
<body>
    <form id="form1" runat="server">
        <div style="font-family:Arial">
            <asp:Label ID="lblTitulo" runat="server" Text="SubRip Subtitles Adjuster"></asp:Label>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Label ID="lblOffset" runat="server" Text="Offset (miliseconds): "></asp:Label>
